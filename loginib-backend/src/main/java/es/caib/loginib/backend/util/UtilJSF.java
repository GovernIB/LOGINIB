package es.caib.loginib.backend.util;
...
import es.caib.loginib.backend.controller.SessionBean;
import es.caib.loginib.backend.controller.ViewDesgloses;
import es.caib.loginib.backend.model.DialogResult;
import es.caib.loginib.backend.model.types.TypeOpcionMenuSuperAdministrador;
import es.caib.loginib.backend.model.types.TypeParametroVentana;
import es.caib.loginib.core.api.exception.ErrorBackException;
import es.caib.loginib.core.api.model.comun.ConstantesNumero;
import es.caib.loginib.core.api.model.login.types.TypeEntorno;
...
import es.caib.loginib.core.api.model.login.types.TypeIdioma;
...
public final class UtilJSF {
	...
	public static String getVersion() {
		return FacesContext.getCurrentInstance().getApplication()
				.evaluateExpressionGet(FacesContext.getCurrentInstance(), "#{negocioModuleConfig}",
						es.caib.loginib.backend.model.comun.ModuleConfig.class)
				.getVersion();
	}
	...
	public static String getUrlOpcionMenuSuperadministrador(final TypeOpcionMenuSuperAdministrador opcion) {
		...
		switch (opcion) {
		case PRUEBA:
			url = PATH_VIEWS + UtilJSF.getViewNameFromClass(ViewDesgloses.class) + EXTENSION_XHTML;
			break;
		default:
