...
public final class ModuleConfig {
    ...
    public void init() {
        try (FileInputStream fis = new FileInputStream(
                System.getProperty("es.caib.loginib.properties.path"));) {
    ...
    public Long getTimeoutTicketAutenticacion() {
        return Long.parseLong(
                propiedades.getProperty("timeoutTicketAutenticacion"));
    }
    ...
    public Long getTimeoutProcesoAutenticacion() {
        return Long.parseLong(
                propiedades.getProperty("timeoutProcesoAutenticacion"));
    }
     ...
     */
    public String getProviderName(String entidad) {
     ...
     * @return spId
     */
    public String getSpId(String entidad) {
     ...
     * @return spSector
     */
    public String getSpSector(String entidad) {
     ...
     */
    public String getSpApplication(String entidad) {
