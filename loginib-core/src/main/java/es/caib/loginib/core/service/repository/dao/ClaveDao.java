...
public interface ClaveDao {
     ...
     */
    String crearSesionLogin(final String entidad, String urlCallback,
            String idioma, final List<TypeIdp> idps, final Integer qaa,
     ...
     * @return Ticket
     */
    TicketClave generateTicketSesionLogin(String idSesion, TypeIdp idp,
            String nif, String nombre, String apellidos, String apellido1,
            String apellido2, DatosRepresentante representante);
     ...
     * @return identificador sesion
     */
    String crearSesionLogut(final String entidad, String pUrlCallback,
            String idioma);
     ...
     *            timeout ticket
     */
    void purgaTicketSesionLogout(Long timeoutSesionExterna,
            Long timeoutTicketExterna);
