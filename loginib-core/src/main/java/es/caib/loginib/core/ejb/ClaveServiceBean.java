...
public class ClaveServiceBean implements ClaveService {
	...
	public String iniciarLoginClave(final String entidad, final String urlCallback, final String urlCallbackError,
			final String idioma, final List<TypeIdp> idps, final int qaa, final boolean forceAuth,
			final String aplicacion) {
		return claveService.iniciarLoginClave(entidad, urlCallback, urlCallbackError, idioma, idps, qaa, forceAuth,
				aplicacion);
	}
