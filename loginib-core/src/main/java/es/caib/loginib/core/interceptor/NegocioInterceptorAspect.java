package es.caib.loginib.core.interceptor;
...
import es.caib.loginib.core.api.exception.DatabaseException;
...
public final class NegocioInterceptorAspect {
	 ...
	 *            JointPoint
	 */
	@Before("@annotation(es.caib.loginib.core.interceptor.NegocioInterceptor)")
	 ...
	 *            Objeto retornado
	 */
	@AfterReturning(pointcut = "@annotation(es.caib.loginib.core.interceptor.NegocioInterceptor)", returning = "retVal")
	 ...
	 *            Exception
	 */
	@AfterThrowing(pointcut = "@annotation(es.caib.loginib.core.interceptor.NegocioInterceptor)", throwing = "ex")
