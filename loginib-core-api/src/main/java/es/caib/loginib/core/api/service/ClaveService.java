...
public interface ClaveService {
	 ...
	 * @return Id sesion
	 */
	String iniciarLoginClave(final String entidad, final String urlCallback, final String idioma,
			final List<TypeIdp> idps, int qaa, boolean forceAuth, final String aplicacion);
