...
public interface ClaveService {
     ...
     * @return Id sesion
     */
    String iniciarLoginClave(final String entidad, final String urlCallback,
            final String idioma, final List<TypeIdp> idps, int qaa,
            boolean forceAuth, final String aplicacion);
     ...
     * @return id sesion
     */
    String iniciarLogoutClave(final String entidad, final String pUrlCallback,
            final String idioma, final String aplicacion);
     ...
     */
    TicketClave procesarRespuestaLoginClave(final String idSesion,
            final String samlResponseB64, String relayState);
     ...
     */
    TicketClave simularRespuestaClave(String pIdSesion, TypeIdp pIdp,
            String pNif, String pNombre, String pApellidos,
     ...
     */
    RespuestaClaveLogout procesarRespuestaLogoutClave(final String pIdSesion,
