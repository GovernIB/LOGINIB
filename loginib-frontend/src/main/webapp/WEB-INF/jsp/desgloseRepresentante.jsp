...
<head>
    ...
    <title>Desglose Representante</title>
		...
		function validate(){
			...
			if(nombre.value.length === 0) {
				...
				if (apellido1.value.length === 0) {
					...
					list.innerHTML = list.innerHTML + "<li><p><fmt:message key="desgloseApellidos.msgValApellido1Repr"/></p></li>";
				}
				error=true;
						...
						<li class="lib-desglose-list">
							...
							<div class="lib-desglose-form lib-desglose-repr">
								<form method="post" id="desgloseNombre"  action="${callback}" onsubmit="return validate()">
								  	...
								  	<button id="enviar" type ="submit"><fmt:message key="datosCertificado.btnContinuar"/></button>
								  </form>
							</div>
						</li>
					</ul>
